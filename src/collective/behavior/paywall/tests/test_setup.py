...
class InstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer(self):
        self.assertIn(IPaywallLayer, registered_layers())

    def test_setup_permission(self):
        permission = 'collective.behavior.paywall: Setup'
    ...
    def test_version(self):
        profile = 'collective.behavior.paywall:default'
...
class UninstallTestCase(unittest.TestCase):
    ...
    def test_addon_layer_removed(self):
        self.assertNotIn(IPaywallLayer, registered_layers())
